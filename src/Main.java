...
//    var x = new Classes.Aluno("a1@com");
//    System.out.println(x.getEmail());
//    x.perguntaFormatada(Busca.pergunta(1));
//    //BuscaPergunta.perguntaFormatada(BuscaPergunta.busca(1));

//      Usuario u = new Usuario("user@email.com", "senha", "aluno");
//      u.perguntaFormatada(Busca.pergunta(1));

//      Index i = new Index();
//      i.init();
//      Professor p = new Professor("prof@test.com", "senha", "professor");
//      p.criaUsuario("falamlk@com", "111", "aluno");
  }
}